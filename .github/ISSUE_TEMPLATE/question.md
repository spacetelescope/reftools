---
name: Question
about: Ask a question about reftools that is neither a bug report nor a feature request.
labels: 'question'
---
...
<!-- If you attempted to run reftools, please run the following snippet and paste the output below:
...
import reftools; print("reftools", reftools.__version__)
# Also include version info of other relevant packages.
-->
